...
public class WebSocketConfig implements WebSocketConfigurer {
    ...
    public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
        registry.addHandler(gameWebSocketHandler(), "/game")
                .setAllowedOrigins("*");    // ← Cambiar a IPs concretas en producción
    }

    /**
     * Expone el handler como bean de Spring para que pueda ser inyectado
     * (por ejemplo, en BattleController para enviar mensajes desde la lógica del juego).
     */
    @Bean
